...
palega=  0x000000,0x0000AA,0x00AA00,0x00AAAA,0xAA0000,0xAA00AA,0xAAAA00,0xAAAAAA,
0x000055,0x0000FF,0x00AA55,0x00AAFF,0xAA0055,0xAA00FF,0AAAAA55,0xAAAAFF,
...
def main():
 ...
 for y in range(0,120):
  for x in range (0,320):
   if ba[120*y+x]==1:
    pixArr[x][y]=pygame.Color(4,4,4)
   else:
    pixArr[x][y]=pygame.Color(0,0,0)
    #print x,y
